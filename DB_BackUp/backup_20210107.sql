...
-- 테이블 데이터 cmw_v2.delivery_info:~20 rows (대략적) 내보내기
/*!40000 ALTER TABLE `delivery_info` DISABLE KEYS */;
INSERT IGNORE INTO `delivery_info` (`idx`, `goodsIdx`, `count`, `size`, `adPercent`, `regUnixtime`, `status`) VALUES
...
-- 테이블 데이터 cmw_v2.goods_info:~18 rows (대략적) 내보내기
...
INSERT IGNORE INTO `goods_info` (`idx`, `category`, `rollType`, `length`, `gName`, `count`, `cost`, `price`, `status`, `regUnixtime`) VALUES
	...
	(23, 1, 30, 17, '순수', 2, 7278, 9300, 1, 1609995602);
...
-- 테이블 데이터 cmw_v2.revenue_info:~150 rows (대략적) 내보내기
