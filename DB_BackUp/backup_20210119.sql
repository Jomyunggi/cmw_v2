...
-- 테이블 데이터 cmw_v2.delivery_info:~28 rows (대략적) 내보내기
...
-- 테이블 데이터 cmw_v2.goods_info:~28 rows (대략적) 내보내기
...
INSERT INTO `goods_info` (`idx`, `mIdx`, `onoff`, `category`, `rollType`, `length`, `gName`, `count`, `cost`, `price`, `status`, `regUnixtime`) VALUES
	...
	(29, 0, 0, 1, 30, 17, '순수', 1, 3800, 5200, 1, 1610611961),
...
-- 테이블 데이터 cmw_v2.revenue_info:~161 rows (대략적) 내보내기
...
INSERT INTO `revenue_info` (`idx`, `cIdx`, `dIdx`, `revenue`, `regUnixtime`, `status`) VALUES
	...
	(3, 35, 2, 24.31, 1606444241, 1),
	(4, 35, 7, 18.95, 1606444241, 1),
	(5, 35, 9, 23.38, 1606444241, 1),
	(6, 35, 5, 17, 1606444241, 1),
	(7, 35, 3, 23, 1606444241, 1),
	(8, 35, 6, 18.95, 1606444241, 1),
	(9, 35, 8, 23.4, 1606444241, 1),
	...
	(154, 35, 21, 32, 1610003850, 1),
	(155, 35, 22, 30.8, 1610111245, 1),
	(156, 35, 23, 27.47, 1610111245, 1),
	(157, 35, 25, 25.6, 1610111245, 1),
	(158, 35, 26, 25.42, 1610111245, 1),
	(159, 35, 24, 27.47, 1610111245, 1),
	(160, 35, 27, 7.74, 1610612165, 1),
	(161, 35, 29, 28.42, 1611038064, 1),
	(162, 35, 28, 25.15, 1611038064, 1);
