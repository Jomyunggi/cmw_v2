...
-- 테이블 데이터 cmw_v2.account_info:~1 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `delivery_info` (
  ...
  `adPercent` int(4) NOT NULL DEFAULT '0' COMMENT '광고비',
  `regUnixtime` int(11) NOT NULL DEFAULT '0',
...
-- 테이블 데이터 cmw_v2.delivery_info:~29 rows (대략적) 내보내기
...
INSERT INTO `delivery_info` (`idx`, `goodsIdx`, `count`, `size`, `adPercent`, `regUnixtime`, `status`) VALUES
	...
	(3, 5, 3, 2, 1200, 1605244335, 1),
	(4, 6, 10, 3, 3, 1605244342, 1),
	(5, 7, 3, 2, 2, 1605244361, 1),
	(6, 8, 3, 3, 4, 1605244367, 1),
	(7, 9, 3, 3, 4, 1605244373, 1),
	(8, 11, 3, 3, 400, 1605244380, 1),
	(9, 12, 3, 3, 400, 1605244387, 1),
	(10, 13, 1, 2, 1200, 1605244394, 1),
	(11, 14, 1, 2, 900, 1605244399, 1),
	(12, 15, 1, 2, 1, 1605244406, 1),
	(13, 16, 1, 2, 1, 1605244412, 1),
	(14, 17, 1, 2, 1200, 1605244419, 1),
	(15, 18, 1, 2, 900, 1605244425, 1),
	(16, 19, 1, 2, 1, 1605244429, 1),
	(17, 20, 1, 2, 1, 1605244435, 1),
	(18, 21, 1, 2, 2, 1605244445, 1),
	(19, 22, 1, 2, 2, 1605244451, 1),
	(20, 5, 2, 1, 5, 1609995453, 9),
	(21, 23, 2, 1, 1000, 1610003819, 1),
	(22, 24, 2, 1, 700, 1610111155, 1),
	(23, 25, 2, 2, 600, 1610111167, 1),
	(24, 26, 2, 2, 600, 1610111175, 1),
	(25, 27, 2, 2, 400, 1610111183, 1),
	(26, 28, 2, 2, 400, 1610111191, 1),
	(27, 29, 1, 1, 3, 1610611996, 1),
...
-- 테이블 데이터 cmw_v2.goods_info:~29 rows (대략적) 내보내기
...
INSERT INTO `goods_info` (`idx`, `mIdx`, `onoff`, `category`, `rollType`, `length`, `gName`, `count`, `cost`, `price`, `status`, `regUnixtime`) VALUES
	...
	(5, 0, 0, 1, 30, 17, '순수', 3, 11122, 14500, 1, 1600233018),
	...
	(14, 0, 0, 2, 16, 180, '고급점보롤180', 1, 12795, 17300, 1, 1600233363),
	(15, 0, 0, 2, 16, 200, '고급점보롤200', 1, 14963, 20300, 1, 1600233465),
	(16, 0, 0, 2, 16, 300, '고급점보롤300', 1, 21207, 28700, 1, 1600233486),
	(17, 0, 0, 2, 16, 150, '꽃지점보롤150', 1, 11660, 15800, 1, 1600233511),
	(18, 0, 0, 2, 16, 180, '꽃지점보롤180', 1, 13418, 18200, 1, 1600233536),
	(19, 0, 0, 2, 16, 200, '꽃지점보롤200', 1, 15710, 21300, 1, 1600233574),
	(20, 0, 0, 2, 16, 300, '꽃지점보롤300', 1, 21993, 29800, 1, 1600233607),
	(21, 0, 0, 4, 100, 100, '네프킨', 1, 9000, 11500, 1, 1600233702),
	(22, 0, 0, 8, 50, 100, '핸드타월', 1, 14500, 18500, 1, 1600233771),
	(23, 0, 0, 1, 30, 17, '순수', 2, 7450, 9950, 1, 1609995602),
	(24, 0, 0, 1, 30, 16, '땡큐', 2, 6950, 9300, 1, 1610110911),
	(25, 0, 0, 1, 30, 22, '자연', 2, 9050, 12050, 1, 1610111021),
	(26, 0, 0, 1, 30, 22, '꿈집', 2, 9050, 12050, 1, 1610111073),
...
-- 테이블 데이터 cmw_v2.revenue_info:~162 rows (대략적) 내보내기
...
INSERT INTO `revenue_info` (`idx`, `cIdx`, `dIdx`, `salePrice`, `revenue`, `regUnixtime`, `status`) VALUES
	...
	(4, 35, 7, 0, 18.95, 1606444241, 1),
	(5, 35, 9, 0, 23.38, 1606444241, 1),
	(6, 35, 5, 0, 17, 1606444241, 1),
	(7, 35, 3, 0, 23, 1606444241, 1),
	(8, 35, 6, 0, 24.3, 1606444241, 1),
	(9, 35, 8, 0, 23.4, 1606444241, 1),
	(10, 35, 10, 20990, 25.29, 1606444241, 1),
	(11, 35, 11, 23990, 26.75, 1606444241, 1),
	(12, 35, 12, 25720, 20.96, 1606444241, 1),
	(13, 35, 13, 34780, 19.92, 1606444241, 1),
	(14, 35, 14, 21900, 25.88, 1606444241, 1),
	(15, 35, 15, 24980, 26.65, 1606444241, 1),
	(16, 35, 16, 26800, 20.78, 1606444241, 1),
	(17, 35, 17, 35990, 20, 1606444241, 1),
	...
	(154, 35, 21, 0, 32, 1610003850, 1),
	(155, 35, 22, 0, 30.8, 1610111245, 1),
	(156, 35, 23, 0, 27.47, 1610111245, 1),
	(157, 35, 25, 0, 25.6, 1610111245, 1),
	(158, 35, 26, 0, 25.42, 1610111245, 1),
	(159, 35, 24, 0, 27.47, 1610111245, 1),
	(160, 35, 27, 0, 7.74, 1610612165, 1),
