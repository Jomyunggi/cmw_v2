...
-- 테이블 데이터 cmw_v2.delivery_info:~34 rows (대략적) 내보내기
...
INSERT INTO `delivery_info` (`idx`, `goodsIdx`, `count`, `size`, `adPercent`, `regUnixtime`, `status`) VALUES
	...
	(2, 4, 4, 3, 400, 1605244327, 1),
	(3, 5, 3, 2, 1435, 1605244335, 1),
	(4, 6, 10, 3, 3, 1605244342, 1),
	(5, 7, 3, 2, 1358, 1605244361, 1),
	(6, 8, 3, 3, 1725, 1605244367, 1),
	(7, 9, 3, 3, 1725, 1605244373, 1),
	(8, 11, 3, 3, 1932, 1605244380, 1),
	(9, 12, 3, 3, 1988, 1605244387, 1),
	(10, 13, 1, 2, 1200, 1605244394, 1),
	(11, 14, 1, 2, 900, 1605244399, 1),
	(12, 15, 1, 2, 300, 1605244406, 1),
	(13, 16, 1, 2, 300, 1605244412, 1),
	(14, 17, 1, 2, 1100, 1605244419, 1),
	(15, 18, 1, 2, 900, 1605244425, 1),
	(16, 19, 1, 2, 300, 1605244429, 1),
	(17, 20, 1, 2, 300, 1605244435, 1),
	(18, 21, 1, 2, 2, 1605244445, 1),
	(19, 22, 1, 2, 2, 1605244451, 1),
	(20, 5, 2, 1, 5, 1609995453, 9),
	(21, 23, 2, 1, 1050, 1610003819, 1),
	(22, 24, 2, 1, 980, 1610111155, 1),
	(23, 25, 2, 2, 1260, 1610111167, 1),
	(24, 26, 2, 2, 1260, 1610111175, 1),
	(25, 27, 2, 2, 1400, 1610111183, 1),
	(26, 28, 2, 2, 1442, 1610111191, 1),
	(27, 29, 1, 1, 658, 1610611996, 1),
	(28, 30, 3, 2, 400, 1611038041, 1),
	(29, 31, 2, 1, 400, 1611038053, 1),
	(30, 32, 1, 1, 735, 1611821233, 1),
	(31, 33, 1, 1, 735, 1611821600, 1),
	(32, 34, 1, 1, 805, 1611822339, 1),
	(33, 35, 1, 1, 826, 1611822349, 1),
	(34, 36, 1, 1, 623, 1611823114, 1);
/*!40000 ALTER TABLE `delivery_info` ENABLE KEYS */;

-- 테이블 데이터 cmw_v2.goods_info:~34 rows (대략적) 내보내기
...
INSERT INTO `goods_info` (`idx`, `mIdx`, `onoff`, `category`, `rollType`, `length`, `gName`, `count`, `cost`, `price`, `status`, `regUnixtime`) VALUES
	...
	(4, 0, 0, 1, 24, 24, '새피아', 4, 14622, 19700, 1, 1600232939),
	...
	(23, 0, 0, 1, 30, 17, '순수', 2, 7450, 9900, 1, 1609995602),
	...
	(27, 0, 0, 1, 30, 24, '황토', 2, 10400, 13900, 1, 1610111105),
	...
	(31, 0, 0, 1, 24, 24, '새피아', 2, 7377, 10000, 1, 1611038007),
...
-- 테이블 데이터 cmw_v2.revenue_info:~167 rows (대략적) 내보내기
...
INSERT INTO `revenue_info` (`idx`, `cIdx`, `dIdx`, `salePrice`, `revenue`, `regUnixtime`, `status`) VALUES
	...
	(2, 35, 1, 0, 15.9, 1606444241, 1),
	(3, 35, 2, 0, 24.3, 1606444241, 1),
	(4, 35, 7, 24640, 611.99, 1606444241, 1),
	(5, 35, 9, 28400, 23.16, 1606444241, 1),
	(6, 35, 5, 19400, 24.66, 1606444241, 1),
	(7, 35, 3, 20500, 23.24, 1606444241, 1),
	(8, 35, 6, 24640, 19.13, 1606444241, 1),
	(9, 35, 8, 27600, 22.61, 1606444241, 1),
	(10, 35, 10, 20990, 25.29, 1606444241, 1),
	(11, 35, 11, 23500, 25.39, 1606444241, 1),
	(12, 35, 12, 25500, 21.91, 1606444241, 1),
	(13, 35, 13, 34600, 19.22, 1606444241, 1),
	(14, 35, 14, 21900, 25.88, 1606444241, 1),
	(15, 35, 15, 24500, 26.65, 1606444241, 1),
	(16, 35, 16, 26500, 20.78, 1606444241, 1),
	(17, 35, 17, 35700, 19.05, 1606444241, 1),
	...
	(78, 41, 1, 0, 15.9, 1606453548, 1),
	(79, 41, 2, 0, 17, 1606453548, 1),
	(80, 41, 7, 0, 17.36, 1606453548, 1),
	(81, 41, 9, 0, 17.09, 1606453548, 1),
	(82, 41, 5, 0, 15.83, 1606453548, 1),
	(83, 41, 3, 0, 17.43, 1606453548, 1),
	(84, 41, 6, 0, 17.36, 1606453548, 1),
	(85, 41, 8, 0, 16.68, 1606453548, 1),
	(86, 41, 10, 0, 18.4, 1606453548, 1),
	(87, 41, 11, 0, 18.58, 1606453548, 1),
	(88, 41, 12, 0, 17.05, 1606453548, 1),
	(89, 41, 13, 0, 16.4, 1606453548, 1),
	(90, 41, 14, 0, 17.6, 1606453548, 1),
	(91, 41, 15, 0, 18.58, 1606453548, 1),
	(92, 41, 16, 0, 17.05, 1606453548, 1),
	(93, 41, 17, 0, 16.2, 1606453548, 1),
	...
	(154, 35, 21, 15000, 27.14, 1610003850, 1),
	(155, 35, 22, 14000, 27.54, 1610111245, 1),
	(156, 35, 23, 18000, 511.11, 1610111245, 1),
	(157, 35, 25, 20000, 26.9, 1610111245, 1),
	(158, 35, 26, 20600, 25.84, 1610111245, 1),
	(159, 35, 24, 18000, 508.58, 1610111245, 1),
	(160, 35, 27, 9400, 31.91, 1610612165, 1),
	(161, 35, 29, 0, 28.42, 1611038064, 1),
	(162, 35, 28, 0, 25.15, 1611038064, 1),
	(163, 35, 30, 10600, 32.17, 1611821241, 1),
	(164, 35, 31, 10600, 347.72, 1611821617, 1),
	(165, 35, 32, 11500, 30.34, 1611822366, 1),
	(166, 35, 33, 11800, 30.1, 1611822366, 1),
	(167, 35, 34, 8900, 33.48, 1611823120, 1);
