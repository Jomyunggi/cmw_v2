...
INSERT INTO `company_info` (`idx`, `companyName`, `license`, `addr`, `tel`, `fax`, `senior`, `email`, `level`, `taxYN`, `fees`, `status`, `regUnixtime`) VALUES
	...
	(38, '11번가', '10', '', '', '', '', '', 4, 0, 11.2, 1, 1605247617),
	(39, '옥션', '9', '', '', '', '', '', 4, 0, 10, 1, 1605247630),
	(40, '지마켓', '9', '', '', '', '', '', 4, 0, 10, 1, 1605247639),
	(41, '스마트스토어', '6', '', '', '', '', '', 4, 0, 10, 1, 1605247661),
...
CREATE TABLE IF NOT EXISTS `delivery_info` (
  ...
  `adPercent` float NOT NULL DEFAULT '0',
  `regUnixtime` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `delivery_info` (`idx`, `goodsIdx`, `count`, `size`, `revenue_hope`, `adPercent`, `regUnixtime`, `status`) VALUES
...
-- 테이블 데이터 cmw_v2.goods_info:~20 rows (대략적) 내보내기
...
INSERT INTO `goods_info` (`idx`, `category`, `rollType`, `length`, `gName`, `count`, `cost`, `price`, `status`, `regUnixtime`) VALUES
	...
	(22, 8, 50, 100, '핸드타월', 1, 14500, 18500, 1, 1600233771);
...
-- 테이블 데이터 cmw_v2.revenue_info:~152 rows (대략적) 내보내기
...
INSERT INTO `revenue_info` (`idx`, `cIdx`, `dIdx`, `revenue`, `regUnixtime`, `status`) VALUES
	...
	(20, 38, 4, 16.21, 1606453331, 1),
	(21, 38, 1, 15.9, 1606453331, 1),
	(22, 38, 2, 17, 1606453331, 1),
	(23, 38, 7, 17.36, 1606453331, 1),
	(24, 38, 9, 17.09, 1606453400, 1),
	(25, 38, 5, 15.83, 1606453400, 1),
	(26, 38, 3, 17.43, 1606453400, 1),
