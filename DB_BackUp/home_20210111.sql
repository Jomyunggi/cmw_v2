...
INSERT INTO `delivery_info` (`idx`, `goodsIdx`, `count`, `size`, `adPercent`, `regUnixtime`, `status`) VALUES
	...
	(21, 23, 2, 1, 4.13, 1610003819, 1),
	(22, 24, 2, 1, 5, 1610111155, 1),
...
INSERT INTO `goods_info` (`idx`, `category`, `rollType`, `length`, `gName`, `count`, `cost`, `price`, `status`, `regUnixtime`) VALUES
	...
	(22, 8, 50, 100, '핸드타월', 1, 14500, 18000, 1, 1600233771),
	(23, 1, 30, 17, '순수', 2, 7334, 9200, 1, 1609995602),
	(24, 1, 30, 16, '땡큐', 2, 7100, 8900, 1, 1610110911),
	(25, 1, 30, 22, '자연', 2, 8880, 11100, 1, 1610111021),
	(26, 1, 30, 22, '꿈집', 2, 8880, 11100, 1, 1610111073),
	(27, 1, 30, 24, '황토', 2, 10422, 13100, 1, 1610111105),
	(28, 1, 30, 26, '데코꿈집', 2, 10808, 13600, 1, 1610111136);
...
INSERT INTO `revenue_info` (`idx`, `cIdx`, `dIdx`, `revenue`, `regUnixtime`, `status`) VALUES
	...
	(4, 35, 7, 17.36, 1606444241, 1),
	(5, 35, 9, 17.09, 1606444241, 1),
	(6, 35, 5, 15.83, 1606444241, 1),
	(7, 35, 3, 18.49, 1606444241, 1),
	(8, 35, 6, 17.36, 1606444241, 1),
	(9, 35, 8, 16.68, 1606444241, 1),
	...
	(154, 35, 21, 18.77, 1610003850, 1),
	(155, 35, 22, 15.83, 1610111245, 1),
	(156, 35, 23, 17.36, 1610111245, 1),
	(157, 35, 25, 16.68, 1610111245, 1),
	(158, 35, 26, 17.09, 1610111245, 1),
	(159, 35, 24, 17.36, 1610111245, 1);
