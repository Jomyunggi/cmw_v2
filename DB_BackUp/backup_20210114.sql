...
-- 테이블 데이터 cmw_v2.delivery_info:~27 rows (대략적) 내보내기
...
INSERT INTO `delivery_info` (`idx`, `goodsIdx`, `count`, `size`, `adPercent`, `regUnixtime`, `status`) VALUES
	...
	(21, 23, 2, 1, 8, 1610003819, 1),
	(22, 24, 2, 1, 3, 1610111155, 1),
	(23, 25, 2, 2, 6, 1610111167, 1),
	(24, 26, 2, 2, 6, 1610111175, 1),
	(25, 27, 2, 2, 3, 1610111183, 1),
	(26, 28, 2, 2, 3, 1610111191, 1),
...
-- 테이블 데이터 cmw_v2.goods_info:~27 rows (대략적) 내보내기
...
INSERT INTO `revenue_info` (`idx`, `cIdx`, `dIdx`, `revenue`, `regUnixtime`, `status`) VALUES
	...
	(154, 35, 21, 18.34, 1610003850, 1),
	(155, 35, 22, 13.59, 1610111245, 1),
	(156, 35, 23, 19.6, 1610111245, 1),
	(157, 35, 25, 17.8, 1610111245, 1),
	(158, 35, 26, 17.87, 1610111245, 1),
	(159, 35, 24, 19.6, 1610111245, 1),
