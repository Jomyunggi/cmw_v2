...
class PHPExcel_Style_Alignment extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
	 ...
	 * @var string
	 */
	protected $_horizontal	= PHPExcel_Style_Alignment::HORIZONTAL_CENTER;
	 ...
	 * @var string
	 */
	protected $_vertical		= PHPExcel_Style_Alignment::VERTICAL_CENTER;
	 ...
	 * @return PHPExcel_Style_Alignment
	 */
	public function setHorizontal($pValue = PHPExcel_Style_Alignment::HORIZONTAL_CENTER) {
		if ($pValue == '') {
			$pValue = PHPExcel_Style_Alignment::HORIZONTAL_CENTER;
		}
	 ...
	 * @return PHPExcel_Style_Alignment
	 */
	public function setVertical($pValue = PHPExcel_Style_Alignment::VERTICAL_CENTER) {
		if ($pValue == '') {
			$pValue = PHPExcel_Style_Alignment::VERTICAL_CENTER;
		}
